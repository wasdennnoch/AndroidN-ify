...
public class TouchAnimator2 {
    ...
    private static final FloatProperty POSITION = new FloatProperty("position") {
        public Float get(TouchAnimator2 touchanimator) {
            return touchanimator.mLastT;
        }

        public Object get(Object obj) {
            return get((TouchAnimator2) obj);
        }

        public void setValue(TouchAnimator2 touchanimator, float f) {
            touchanimator.setPosition(f);
        }

        public void setValue(Object obj, float f) {
            setValue((TouchAnimator2) obj, f);
        }
    };
    ...
    private TouchAnimator2(View targets[], KeyframeSet keyframeset[], float startDelay, float endDelay, Interpolator interpolator, Listener listener) {
        mTargets = targets;
    ...
    public static class Builder {
        ...
        public TouchAnimator2 build() {
            return new TouchAnimator2(mTargets.toArray(new View[mTargets.size()]), mValues.toArray(new KeyframeSet[mValues.size()]), mStartDelay, mEndDelay, mInterpolator, mListener);
        }
